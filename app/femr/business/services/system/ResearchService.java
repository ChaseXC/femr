...
//        }
    ...
    private ResearchResultSetItem buildVitalResultSet(List<? extends IResearchEncounter> encounters, ResearchFilterItem filters) {
        ...
        for (IResearchEncounter encounter : encounters) {
            ...
            // get secondary data
            Pair<ResearchResultSetItem, ResearchResultItem> pair = getSecondaryPatientDataFromFilter(patient, encounter, filters, resultItem, resultSet);
            resultSet = pair.getKey();
            resultItem = pair.getValue();
    ...
    private Pair<ResearchResultSetItem, ResearchResultItem> getSecondaryPatientDataFromFilter(IPatient patient, IResearchEncounter encounter, ResearchFilterItem filters, ResearchResultItem resultItem, ResearchResultSetItem resultSet) {
        if (filters.getSecondaryDataset() != null) {
            if (filters.getSecondaryDataset().equals("gender")) {
                    // Set valuemap if not already
                if (resultSet.getSecondaryValueMap() == null) {
        ...
        return new Pair<ResearchResultSetItem, ResearchResultItem>(resultSet, resultItem);
    }
